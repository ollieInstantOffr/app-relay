...
const GO: Record<string, string> = {
  o: '/', h: '/hosts', l: '/load-balancer', c: '/certificates', a: '/access', t: '/streams', g: '/logs', v: '/history', s: '/settings', d: '/docs', n: '/dns',
}
...
const SECTIONS: { title: string; rows: [string, string[]][] }[] = [
  ...
  { title: 'Go to', rows: [['Overview', ['G', 'O']], ['Hosts', ['G', 'H']], ['Load balancer', ['G', 'L']], ['Certificates', ['G', 'C']], ['Access lists · Streams', ['G', 'A', '·', 'G', 'T']], ['Logs · History · Settings', ['G', 'G', '·', 'G', 'V', '·', 'G', 'S']], ['Public DNS · Documentation', ['G', 'N', '·', 'G', 'D']]] },
