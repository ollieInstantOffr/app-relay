  ...
  return (
    <>
      ...
      <Callout tone="info" icon="info">
        nginx owns public TLS and domains. HAProxy owns pools and health. Public HTTP traffic always enters through nginx; only raw TCP/UDP frontends bind to a LAN or public IP directly.
      </Callout>
